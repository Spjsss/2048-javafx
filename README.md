...
* **Smooth User Interaction:** Low-latency **Keyboard Input** (Arrow Keys/WASD) for fluid gameplay.
...
```bash
git clone [https://github.com/Spjsss/2048-javafx.git](https://github.com/Spjsss/2048-javafx.git)
```
### 2. Open the project
